...
const WhatsAppButton = () => {
  ...
  return (
    <a
      href={`https://wa.me/573203240400?text=${whatsappMessage}`}
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-20 right-6 md:bottom-6 z-50 animate-bounce"
      aria-label="Contactar por WhatsApp"
    >
      <Button
        variant="hero"
        size="lg"
        className="rounded-full w-16 h-16 p-0 shadow-lg hover:shadow-xl bg-[#25D366] hover:bg-[#20BD5A] border-none"
      >
        <svg 
          viewBox="0 0 24 24" 
          className="w-9 h-9"
