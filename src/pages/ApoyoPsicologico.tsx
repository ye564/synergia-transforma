  ...
  const faqs = [
    {
      ...
      respuesta:
        "Puedes agendar tu primera sesión a través de WhatsApp (+57 320 324 0400) o desde nuestro formulario de contacto. Te contactaremos para coordinar día y hora según tu disponibilidad. La primera orientación es gratuita.",
    },
    {
