...
const Admisiones = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const necesidadesTexto = formData.necesidades.join(", ");
...
Servicios de interés: ${necesidadesTexto}
...
${formData.mensaje ? `Mensaje adicional:\n${formData.mensaje}` : "Sin mensaje adicional"}
      ...
      toast({
        ...
        description: "Gracias por tu interés. Te contactaremos pronto por WhatsApp o correo.",
      });
      ...
      toast({
        ...
        description: "No pudimos procesar tu inscripción. Por favor intenta de nuevo.",
        variant: "destructive",
      });
    } finally {
